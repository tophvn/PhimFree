...
<body>
    ...
    <!-- <div class="banner">
        <div class="banner-content">
            <h1>TV Shows Nổi Bật</h1>
            <p>Khám phá những chương trình TV hấp dẫn nhất!</p>
            <a href="#" class="btn">Xem ngay</a>
        </div>
    </div> -->

    <div class="container"><br><br><br><br><br>
        <h2>TV SHOWS MỚI CẬP NHẬT</h2><br>
        ...
        if ($data && isset($data['status']) && $data['status'] === 'success' && isset($data['data']['items']) && !empty($data['data']['items'])) {
            ...
            foreach ($movies as $movie) {
                ...
                // Kiểm tra và thay 'tvshow' hoặc 'tvshows' thành 'Show'
            ...
            if ($total_pages > 1) {
                ...
                if ($page > 1) {
                    echo "<a href='tv-shows.php?page=" . ($page - 1) . "&sort_field={$sort_field}' class='page-link'>Trang trước</a>";
                } else {
                    echo "<span class='disabled'>Trang trước</span>";
                }
                echo " <span>Trang $page / $total_pages</span> ";
                if ($page < $total_pages) {
                    echo "<a href='tv-shows.php?page=" . ($page + 1) . "&sort_field={$sort_field}' class='page-link'>Trang sau</a>";
                } else {
